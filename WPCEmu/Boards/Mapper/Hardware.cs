...
namespace WPCEmu.Boards.Mapper
{
    ...
    {
        public struct ReturnModelStruct
        {
            public ushort offset;
            public string subsystem;

            public ReturnModelStruct(ushort offset, string subsystem)
            {
                this.offset = offset;
        ...
        static ReturnModelStruct buildReturnModel(ushort offset, string subsystem)
        {
            return new ReturnModelStruct(offset, subsystem);
        }

        public static ReturnModelStruct getAddress(ushort offset)
        {
            //if (!offset.HasValue) 
            //{
