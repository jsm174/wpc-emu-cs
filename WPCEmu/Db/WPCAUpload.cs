namespace WPCEmu.Db
{
    public class UploadWpcAlpha : IDb
    {
        public string name => "UPLOAD: WPC-Alphanumeric Emulation";
        ...
        {
            new SwitchMapping { id = "11", name = "SWITCH 11" },
            new SwitchMapping { id = "12", name = "SWITCH 12" },
            new SwitchMapping { id = "13", name = "SWITCH 13" },
            new SwitchMapping { id = "14", name = "SWITCH 14" },
            ...
            new SwitchMapping { id = "21", name = "SWITCH 21" },
            new SwitchMapping { id = "22", name = "SWITCH 22" },
            new SwitchMapping { id = "23", name = "SWITCH 23" },
        ...
        public Initialise? initialise => null;
